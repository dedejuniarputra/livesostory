        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b border-dark-800">
                    <th class="text-left py-3 px-4 text-xs uppercase tracking-widest text-gray-500 font-medium">#</th>
                    <th class="text-left py-3 px-4 text-xs uppercase tracking-widest text-gray-500 font-medium">Gambar</th>
                    <th class="text-left py-3 px-4 text-xs uppercase tracking-widest text-gray-500 font-medium">Nama</th>
                    <th class="text-left py-3 px-4 text-xs uppercase tracking-widest text-gray-500 font-medium">Jumlah Paket</th>
                    <th class="text-left py-3 px-4 text-xs uppercase tracking-widest text-gray-500 font-medium">Status</th>
                    <th class="text-right py-3 px-4 text-xs uppercase tracking-widest text-gray-500 font-medium">Aksi</th>
                </tr>
            </thead>
            <tbody>
                @forelse($categories as $cat)
                    <tr class="border-b border-dark-800/50 hover:bg-dark-800/30 transition-colors">
                        ...
                        <td class="py-3 px-4">
                            ...
                            @else
                                <div class="w-16 h-12 bg-dark-800 rounded border border-dark-700 flex items-center justify-center">
                        ...
                        <td class="py-3 px-4">
                            @if($cat->is_active)
                                <span class="inline-block px-2 py-0.5 text-[10px] bg-green-500/10 text-green-400 rounded uppercase tracking-wider">Active</span>
                            @else
                                <span class="inline-block px-2 py-0.5 text-[10px] bg-red-500/10 text-red-400 rounded uppercase tracking-wider">Inactive</span>
                            @endif
                        </td>
