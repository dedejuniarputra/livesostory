...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
        <!-- Total Bookings -->
        <div
            class="bg-blue-600/10 border border-blue-500/40 p-4 md:p-6 rounded-xl shadow-sm hover:border-blue-500 transition-all group">
            <div class="flex items-center gap-4">
                <div
                    class="p-3 bg-blue-500/20 rounded-lg text-blue-400 group-hover:scale-110 transition-transform flex-shrink-0">
                ...
                <div>
                    <div class="text-xl md:text-3xl font-bold mb-0.5 text-blue-400">
                        {{ number_format($stats['total_bookings']) }}
                    </div>
                    <div class="text-[10px] text-blue-500/60 uppercase tracking-widest font-bold">Total Pesanan</div>
                </div>
            </div>
        </div>
        ...
        <!-- Total Revenue -->
        <div
            class="bg-emerald-600/10 border border-emerald-500/40 p-4 md:p-6 rounded-xl shadow-sm hover:border-emerald-500 transition-all group">
            <div class="flex items-center gap-4">
                <div
                    class="p-3 bg-emerald-500/20 rounded-lg text-emerald-400 group-hover:scale-110 transition-transform flex-shrink-0">
                    <svg class="w-6 h-6 md:w-7 md:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <div class="min-w-0">
                    <div class="text-xl md:text-3xl font-bold mb-0.5 text-emerald-400 truncate">Rp
                        {{ number_format($stats['total_revenue'], 0, ',', '.') }}
                    </div>
                    <div class="text-[10px] text-emerald-500/60 uppercase tracking-widest font-bold">Total Omset</div>
                </div>
            </div>
        </div>
        ...
        <!-- Total Packages -->
        <div
            class="bg-amber-600/10 border border-amber-500/40 p-4 md:p-6 rounded-xl shadow-sm hover:border-amber-500 transition-all group">
            <div class="flex items-center gap-4">
                <div
                    class="p-3 bg-amber-500/20 rounded-lg text-amber-500 group-hover:scale-110 transition-transform flex-shrink-0">
                    <svg class="w-6 h-6 md:w-7 md:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <div>
                    <div class="text-xl md:text-3xl font-bold mb-0.5 text-amber-500">
                        {{ number_format($stats['total_packages']) }}
                    </div>
                    <div class="text-[10px] text-amber-500/60 uppercase tracking-widest font-bold">Total Paket</div>
                </div>
            </div>
        </div>
        ...
        <!-- Portfolio Items -->
        <div
            class="bg-purple-600/10 border border-purple-500/40 p-4 md:p-6 rounded-xl shadow-sm hover:border-purple-500 transition-all group">
            <div class="flex items-center gap-4">
                <div
                    class="p-3 bg-purple-500/20 rounded-lg text-purple-400 group-hover:scale-110 transition-transform flex-shrink-0">
                    <svg class="w-6 h-6 md:w-7 md:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <div>
                    <div class="text-xl md:text-3xl font-bold mb-0.5 text-purple-400">
                        {{ number_format($stats['total_portfolios']) }}
                    </div>
                    <div class="text-[10px] text-purple-500/60 uppercase tracking-widest font-bold">Item Portofolio</div>
                </div>
            </div>
        </div>
    </div>
