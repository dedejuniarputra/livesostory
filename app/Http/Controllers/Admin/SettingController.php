...
class SettingController extends Controller
{
    public function index()
    {
        $settings = [
            ...
            'default_slots_per_day' => Setting::get('default_slots_per_day', '1'),
    ...
    {
        try {
            $fields = ['hero_title', 'hero_subtitle', 'hero_description', 'whatsapp_number', 'instagram', 'tiktok', 'default_slots_per_day', 'payment_instructions'];
