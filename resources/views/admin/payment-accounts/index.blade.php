...
@section('content')
    ...
    <div class="max-w-2xl mb-8">
        ...
        <form action="{{ route('admin.payment-accounts.store') }}" method="POST"
            class="bg-dark-800/50 border border-dark-700 p-6 rounded">
            @csrf
            ...
            <button type="submit"
                class="px-4 py-2.5 bg-gold-400 text-dark-950 text-xs tracking-widest uppercase font-semibold hover:bg-gold-300 transition-colors rounded">Tambah</button>
        </form>
    </div>
